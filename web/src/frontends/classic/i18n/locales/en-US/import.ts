export default {
  import: {
    ...
    subscription: {
      ...
      providerLogin: 'Choose a sign-in method',
      emailStep: 'Or use an email code. One code a minute, up to 3.',
      emailAddress: 'Email',
      emailSend: 'Send code',
      emailCode: 'Code',
      emailVerify: 'Verify and sign in',
      emailSent: 'The code was sent.',
      emailInvalid: 'Enter a valid email address and code.',
      emailLimited: 'Too many email sign-in attempts. Start again.',
